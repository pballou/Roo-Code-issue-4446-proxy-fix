...
import { createProxyAwareNodeHttpHandler } from "./utils/http"
...
export class AwsBedrockHandler extends BaseProvider implements SingleCompletionHandler {
	...
	constructor(options: ProviderSettings) {
        ...
        const httpHandler = createProxyAwareNodeHttpHandler("bedrock")
		if (httpHandler) {
    ...
    // Centralized proxy/CA handler methods migrated to src/shared/http.ts
